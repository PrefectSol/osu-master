...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalSpacer_6 = new QSpacerItem(56, 108, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        gridLayout_3->addWidget(graphicsView, 2, 2, 1, 1);
        ...
        gridLayout_3->addItem(verticalSpacer_8, 1, 2, 1, 1);
        ...
        gridLayout_3->addWidget(label_27, 0, 2, 1, 1);
        ...
        gridLayout_3->addWidget(label_26, 4, 2, 1, 1);
        ...
        picturelabel_2->setMinimumSize(QSize(120, 120));

        gridLayout_2->addWidget(picturelabel_2, 1, 0, 2, 1);

        ranklabel = new QLabel(overviewPage_2);
        ranklabel->setObjectName("ranklabel");

        gridLayout_2->addWidget(ranklabel, 2, 2, 1, 1);

        globalranklabel = new QLabel(overviewPage_2);
        globalranklabel->setObjectName("globalranklabel");

        gridLayout_2->addWidget(globalranklabel, 2, 1, 1, 1);

        usernamelabel_2 = new QLabel(overviewPage_2);
        usernamelabel_2->setObjectName("usernamelabel_2");
        usernamelabel_2->setFont(font);

        gridLayout_2->addWidget(usernamelabel_2, 1, 1, 1, 2);


        gridLayout_4->addLayout(gridLayout_2, 1, 3, 1, 1);

        horizontalSpacer_10 = new QSpacerItem(36, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_4->addItem(horizontalSpacer_10, 1, 4, 1, 1);

        verticalSpacer_11 = new QSpacerItem(59, 70, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_4->addItem(verticalSpacer_11, 2, 3, 1, 1);

        verticalSpacer_7 = new QSpacerItem(20, 69, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        verticalSpacer_9 = new QSpacerItem(20, 160, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        dateTimeEdit = new QDateTimeEdit(otherPage);
        dateTimeEdit->setObjectName("dateTimeEdit");

        gridLayout_5->addWidget(dateTimeEdit, 1, 0, 1, 1);

        dial = new QDial(otherPage);
        dial->setObjectName("dial");
        dial->setMinimumSize(QSize(400, 400));

        gridLayout_5->addWidget(dial, 2, 1, 2, 2);
        ...
        horizontalSpacer_16 = new QSpacerItem(277, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_5->addItem(horizontalSpacer_16, 3, 0, 1, 1);

        verticalSpacer_10 = new QSpacerItem(20, 21, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_5->addItem(verticalSpacer_10, 4, 2, 1, 1);

        calendarWidget = new QCalendarWidget(otherPage);
        calendarWidget->setObjectName("calendarWidget");

        gridLayout_5->addWidget(calendarWidget, 0, 0, 1, 1);

        spinBox = new QSpinBox(otherPage);
        spinBox->setObjectName("spinBox");

        gridLayout_5->addWidget(spinBox, 2, 0, 1, 1);

        doubleSpinBox = new QDoubleSpinBox(otherPage);
        doubleSpinBox->setObjectName("doubleSpinBox");

        gridLayout_5->addWidget(doubleSpinBox, 1, 1, 1, 1);

        fontComboBox = new QFontComboBox(otherPage);
        fontComboBox->setObjectName("fontComboBox");

        gridLayout_5->addWidget(fontComboBox, 0, 1, 1, 1);

        comboBox = new QComboBox(otherPage);
        comboBox->setObjectName("comboBox");

        gridLayout_5->addWidget(comboBox, 4, 0, 1, 1);
        ...
        contentViewer->setCurrentIndex(8);
