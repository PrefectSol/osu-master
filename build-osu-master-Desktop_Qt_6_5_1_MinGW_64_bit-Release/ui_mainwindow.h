...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_4->addItem(horizontalSpacer_6, 1, 0, 2, 1);
        ...
        gridLayout_4->addItem(horizontalSpacer_7, 1, 2, 2, 1);
        ...
        gridLayout_4->addItem(horizontalSpacer_10, 1, 4, 2, 1);
        ...
        gridLayout_4->addLayout(verticalLayout_7, 2, 3, 1, 1);

        verticalSpacer_11 = new QSpacerItem(59, 70, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_4->addItem(verticalSpacer_11, 3, 3, 1, 1);
