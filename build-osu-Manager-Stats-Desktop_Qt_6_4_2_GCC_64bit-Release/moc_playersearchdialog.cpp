...
#include <memory>
#include "../osu-Manager-Stats/playersearchdialog.h"
...
namespace {
struct qt_meta_stringdata_PlayerSearchDialog_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_PlayerSearchDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_PlayerSearchDialog_t qt_meta_stringdata_PlayerSearchDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_PlayerSearchDialog[] = {
...
Q_CONSTINIT const QMetaObject PlayerSearchDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_PlayerSearchDialog.offsetsAndSizes,
    qt_meta_data_PlayerSearchDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_PlayerSearchDialog_t,
        // Q_OBJECT / Q_GADGET
...
void *PlayerSearchDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlayerSearchDialog.stringdata0))
