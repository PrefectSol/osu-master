...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        talantPage->setObjectName("talantPage");
        horizontalLayout_6 = new QHBoxLayout(talantPage);
        horizontalLayout_6->setObjectName("horizontalLayout_6");
        label_2 = new QLabel(talantPage);
        label_2->setObjectName("label_2");

        horizontalLayout_6->addWidget(label_2);

        contentViewer->addWidget(talantPage);
        page_2 = new QWidget();
        ...
        contentViewer->addWidget(page_2);
        page_3 = new QWidget();
        ...
        contentViewer->addWidget(page_3);
        page_4 = new QWidget();
        ...
        contentViewer->addWidget(page_4);
        page_5 = new QWidget();
        ...
        startDownloaderButton = new QPushButton(page_5);
        ...
        contentViewer->addWidget(page_6);
